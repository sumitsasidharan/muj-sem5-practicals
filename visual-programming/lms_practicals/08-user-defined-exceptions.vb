' Exercise 8: Create a program to understand the uses of User-Defined
' Exceptions in VB.NET Exception Handling.
...
Module User_Exception
  ...
  Public Class StudentManagement
    ...
    Sub ShowDetail()
      If (stud = 0) Then
      Throw (New StudentIsZeroException(" Student roll no 'zero' does not
      exist"))
      Else
